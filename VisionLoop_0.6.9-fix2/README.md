...
**Versão 0.6.9-fix2** — 17/08/2026 · O histórico de mudanças fica em [CHANGELOG.md](CHANGELOG.md).
...
→ Aconteceu uma vez na 0.6.9, quando a coluna `expira_em` ainda não existia no banco. A partir da 0.6.9-fix isso não derruba mais nada: o app funciona sem prazo, e a tela de envio avisa quando é esse o caso.
...
→ A varredura de vencidos roda de minuto em minuto, então o corte pode acontecer até cerca de um minuto depois do horário marcado — nunca antes.
